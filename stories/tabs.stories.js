  ...
  .add(
    ...
    () => ({
      ...
      template: `
        ...
        <co-tabs activeName="3" align="center"
                 :custom="{background: '#333', border: '#999', activeColor: 'blue', font: '#fff', activeBackground: 'red'}">
          <co-tab-pane name="1" label="Tab A">
            <div style="height: 150px; background: #0e90d2"></div>
          </co-tab-pane>
          <co-tab-pane name="2" label="Tab B" disabled>
        ...
        <co-tabs activeName="3" type="line" align="right" :interval="1500">
          <co-tab-pane name="1" label="Tab A">
            <div style="height: 150px; background: #0e90d2"></div>
          </co-tab-pane>
          <co-tab-pane name="2" label="Tab B" disabled>
